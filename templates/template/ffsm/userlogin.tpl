...
<!--div class="username">
    <span style="float:left;margin-left:5px;">验 证 码：</span>
    <div class="inputOuter2">
<img src="gd_sub_num.php" onclick="this.src='gd_sub_num.php?time='+new Date().getTime()">
        <input type="text" name="yzm" id="yzm" size="10" maxlength="10" class="inputstyle2 input1" style="padding: 5px;width: 35px;height: 17px;margin-left: 5px;border: 1px solid rgba(0, 0, 0, .2);" >
</div>
</div-->
</div>
<div class="botton" >
