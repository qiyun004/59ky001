...
<script>
        ...
        $('.dashi_point_box').on('click',function(){
            if($(this).attr('data-cid')=='one'){
                ...
                if($(this).hasClass('play')){
                    ...
                    $(this).addClass('play');
                    $('#myAudio').attr('src','https://ky.jiangyunhan.com/m/video/bzjp_top.mp3');
                    audio.play();
                ...
                if($(this).hasClass('play')){
                    ...
                    $('.dashi_point_box').removeClass('play');
                    $(this).addClass('play');
                    $('#myAudio').attr('src','https://ky.jiangyunhan.com/m/video/bzjp_bottom.mp3');
                    audio.play();
                    $(this).next('.dashi_audio_time').removeClass('newMsg');
                }
            }
        ...
        audio.addEventListener("play", function(){
            ...
            if($('#myAudio').attr('src')=='https://ky.jiangyunhan.com/m/video/bzjp_top.mp3'){
                clearTimeout(clearTime);
                $('#Atwo').attr('src',"/statics/ffsm/bazijp/img/img_yuyin3.png");
                setTimeAnimation('#Aone');
            }
            if($('#myAudio').attr('src')=='https://ky.jiangyunhan.com/m/video/bzjp_bottom.mp3'){
                clearTimeout(clearTime);
            ...
            <div class="common-fixed-bottom">
              <div class="list">
                <ul>
                  ...
                  <li class="left index">
                    <a href="http://ky.jiangyunhan.com/?ac=cyxp">
                      <span>再测一次</span></a>
                  </li>
...
.kefu_btn::before {content:'';width:30px;height:30px;background:url('http://ky.jiangyunhan.com/statics/ffsm/bazijp/img/wen.png') no-repeat;background-size:100% 100%;display:inline-block;vertical-align:middle;margin-right:15px;margin-bottom:8px;}
...
<audio src="https://ky.jiangyunhan.com/m/video/bzjp_bottom.mp3" id="Atwo"></audio>
        </div>
