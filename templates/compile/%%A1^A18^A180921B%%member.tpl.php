<?php /* Smarty version 2.6.25, created on 2020-07-22 10:30:18
         compiled from ffsm/member.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
<title>会员中-个人推广分销中心-奇云网</title>
...
<div class="login"><div class="ui-avatar"><span style="background-image:url(<?php if ($this->_tpl_vars['member']['headimgurl']): ?><?php echo $this->_tpl_vars['member']['headimgurl']; ?>
<?php else: ?>/statics/user/images/userlogo.png<?php endif; ?>)" onclick='location.href="/?ac=member"'></span></div>
<div class="login_t">
<h3><span style="color:#0180cf">昵称：</span><?php echo $this->_tpl_vars['member']['nickname']; ?>
&nbsp;&nbsp;&nbsp;【<em style="margin:5px 0;font-size:14px;"><font color="red"><?php if ($this->_tpl_vars['member']['class'] == 1): ?>注册用户<?php elseif ($this->_tpl_vars['member']['class'] == 2): ?>微信用户<?php else: ?>QQ用户<?php endif; ?></font></em>】</h3>
<span class="login_lj" style="font-size:14px;">我的佣金：<font color="red" size="3"><?php echo $this->_tpl_vars['member']['dl_syjf']; ?>
</font> 元 </span>
<span class="login_lj" ><p style="margin:5px 0;font-size:14px;"><?php if ($this->_tpl_vars['member']['phone']): ?>电话：<?php echo $this->_tpl_vars['member']['phone']; ?>
<a href="?ac=user_spacecp" class="zlxgan">资料修改</a><?php else: ?><a href="?ac=user_spacecp" class="zlxgan">设置电话</a><?php endif; ?></p></span>  
  </div>
</div>
...
<tr>
  ...
  <td><textarea name="name" class="make_resume_input" id="name" style="width:80%; height:30px;margin-bottom: 0;resize: none;">http://<?php echo $this->_tpl_vars['dqurl']; ?>
/?dl=<?php echo $this->_tpl_vars['member']['uid']; ?>
</textarea></td>
</tr>
<tr>
<td align="right" valign="top" style="padding-top:6px;">二维码：</td>
<td><img src="http://qr.liantu.com/api.php?bg=ffffff&gc=222222&el=l&w=150&m=10&text=<?php echo $this->_tpl_vars['dqurl']; ?>
/?dl=<?php echo $this->_tpl_vars['member']['uid']; ?>
" width="150" height="150" style="border: 1px solid rgba(0, 0, 0, .2); padding:4px; margin-top:5px;"></td>
</tr>
