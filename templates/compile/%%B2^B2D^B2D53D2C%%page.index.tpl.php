<?php /* Smarty version 2.6.25, created on 2020-07-22 10:30:44
         compiled from admin/page.index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'admin/page.index.tpl', 271, false),)), $this); ?>
...
<?php else: ?>未知操作名称<?php endif; ?></a>
                ...
                <?php else: ?>
                <tr>
                    <td colspan="<?php echo count($this->_tpl_vars['_dbfield']['allTableField']); ?>
...
&ac=video_batch_del">批量删除</button>-->
            <?php if (isset ( $this->_tpl_vars['_allowAction']['add'] ) && ! empty ( $this->_tpl_vars['_allowAction']['add'] )): ?>
                ...
                <A href="?ct=<?php echo $this->_tpl_vars['ct']; ?>
&ac=add&TB_iframe=true&width=<?php echo $this->_tpl_vars['_allowAction']['add']['width']+300; ?>
&height=<?php echo $this->_tpl_vars['_allowAction']['add']['height']+300; ?>
">添加</A>
